...
def main():
    ...
    logging.info("EPOCH 1: Core Pipeline & Entity Discovery")
    
    try:
        run_epoch1_pipeline()
        
        print("\n" + "="*60)
        print("EPOCH 1 PIPELINE COMPLETED SUCCESSFULLY!")
        print("="*60)
        print("\nResults:")
        print("- Mock data processed through Triage Agent")
        print("- Entities discovered and stored in kultivator.db")
        print("- Placeholder wiki files created in /wiki subdirectories")
        print("\nCheck the following:")
        print("- kultivator.db for entity records")
        print("- wiki/ directories for placeholder .md files")
